...
1. Define a class Node to describe a node for a cicular doubly linked list.
2. Define a class CDLL to implement Circular Doubly Linked List with \_\_init\_\_\(\) method to create and initialise last reference variable.
